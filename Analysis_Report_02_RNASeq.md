...
**Figure 5**: Here we show the relationship between scaled read counts and cancer stage, separated by age of diagnosis and further discriminated by gender.

![](Analysis_Report_02_RNASeq_files/figure-markdown_github-ascii_identifiers/age-by-cancer-stage-by-smoking-status-1.png)

**Figure 6**: This figure shows the relationship between stage of cancer and age at diagnosis, further separated by smoking status.

![](Analysis_Report_02_RNASeq_files/figure-markdown_github-ascii_identifiers/smoking-status-by-gender-1.png)

**Figure 7**: Here we see the relationship between gender and smoking status.

![](Analysis_Report_02_RNASeq_files/figure-markdown_github-ascii_identifiers/make-boxplot-of-highly-expressed-genes-1.png)

**Figure 8**: This figure shows the relationship between scaled read counts per gene separated by cancer stage and further discriminated by gender.
