...
![](Analysis_Report_02_RNASeq_files/figure-markdown_github-ascii_identifiers/smoking-status-by-age-1.png)
...
**Figure 8**: Here we see the relationship between gender and smoking status.

![](Analysis_Report_02_RNASeq_files/figure-markdown_github-ascii_identifiers/make-boxplot-of-highly-expressed-genes-1.png)

**Figure 9**: This figure shows the relationship between scaled read counts per gene separated by cancer stage and further discriminated by gender.
